    ...
    <div>
      ...
      <section>
        ...
        <p className="text-sm my-4 leading-6">
          ...
          <br />
          長時間労働、社会保険未加入など業界での課題は多く、
          <br />
          美容業界から他業界での転職をする方も多く、
          <br />
          最近では専門学校に入学し、国家試験を取得しても美容業界に 就職しない方も多いとのことです。
        </p>
        <p className="text-sm my-4 leading-6">
          まずは美容業界からの離反を防ぐために、1人でも多くの方に業界での転職や就職をサポートすることをしております。
          <br />
          「働くを近くに」美容業界で良いサロンに就職転職することで人手不足解消することが我々の介在価値だと考えます。
        </p>
        <p className="text-sm my-4 leading-6">
          その後、集客課題や経営課題、美容サービスを利用する方々の幸せに貢献できるようにサービス展開を目指しいきます。
          <br />
          ミッション実現のため、我々のサービスや思想を拡げていけるように 努力してまいります。
        </p>
